          ...
          <div>
            <div className="flex justify-center mb-4">
              ...
              {paused ? (
                <Button
                  ...
                  className="bg-yellow-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded"
                >
                  Resume
                </Button>
              ) : (
            ...
            <div className="flex justify-center mb-4">
              ...
              <Input
                ...
                className="bg-gray-100 border border-gray-300 rounded-lg py-2 px-4 w-full max-w-xs text-blue-500"
                placeholder="Enter your guess"
              />
              {/* Button to submit the guess */}
              <Button
                onClick={handleGuess}
                className="bg-blue-700 hover:bg-green-600 text-white font-bold py-2 px-4 rounded ml-4"
              >
                Guess
              </Button>
            </div>
